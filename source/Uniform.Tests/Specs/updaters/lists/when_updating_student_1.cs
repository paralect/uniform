...
{
    public class when_updating_student_1 : _lists_context
    {
        Because of = () =>
        {
        ...
        It should_update_student_at_index_0 = () =>
            user.Student[0].Name.ShouldEqual("Super Tom");

        It should_have_unchanged_id_at_index_1 = () =>
            user.Student[1].StudentId.ShouldEqual("student2");

        It should_not_update_student_at_index_1 = () =>
            user.Student[1].Name.ShouldEqual("John");
    }
}