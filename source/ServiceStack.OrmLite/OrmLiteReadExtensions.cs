...
namespace ServiceStack.OrmLite
{
	...
	public static class OrmLiteReadExtensions
	{
        ...
        public static Object FirstOrDefault(this IDbCommand dbCmd, Type returnType, string filter)
        {
            using (var dbReader = dbCmd.ExecReader(
                OrmLiteConfig.DialectProvider.ToSelectStatement(returnType, filter)))
            {
                return dbReader.ConvertTo(returnType);
            }
        }
